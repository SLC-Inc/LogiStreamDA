...
public class Inventory_LocActivity extends AppCompatActivity {
    private Handler handler = new Handler();
    private TextView msgText,volLabel,numLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.volLabel);
        //共通クラス取得
...
//        numLabel.setText("実数量");
        ...
        qrcodeReadButton.setOnClickListener( v-> {
            IntentIntegrator integrator = new IntentIntegrator(Inventory_LocActivity.this);
            //カメラ起動(QLコード読取画面に遷移)
        ...
        nextButton.setOnClickListener( v-> {
            //次画面遷移
            Intent intent = new Intent(Inventory_LocActivity.this,Inventory_LocActivity2.class);
            //次画面で使用する値セット
